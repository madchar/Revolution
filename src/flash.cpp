...
bool Flash::getPixelColumnDMA(uint8_t imageNo, uint8_t columnNo,
	...
	DMA2->HIFCR = (uint32_t) ((DMA_FLAG_DMEIF5 | DMA_FLAG_FEIF5 | DMA_FLAG_HTIF5
			| DMA_FLAG_TCIF5 | DMA_FLAG_TEIF5) & RESERVED_MASK );
	DMA2->HIFCR = (uint32_t) ((DMA_FLAG_DMEIF4 | DMA_FLAG_FEIF4 | DMA_FLAG_HTIF4
			| DMA_FLAG_TCIF4 | DMA_FLAG_TEIF4) & RESERVED_MASK );
